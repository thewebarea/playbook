...
create host files in /var/www/host.name with aliases (www.)host.name
"
    exit
fi
...
mkdir /var/www/$1
ls -s /var/www/$1 /var/www/www.$1
chown www-data:www-data -R /var/www/$1
chown www-data:www-data -R /var/www/www.$1

cp /var/www/host.php $1/index.php
